...
// ============================================================================
// 🌍 STATIC MENU CONFIGURATION POOL (Bebas Alokasi Memori Ulang Per Render)
// ============================================================================
const ADMIN_MENUS_CONFIG = [
...
// ============================================================================
// ⚙️ MEMOIZED MASTER CONTROL HUB COMPONENT
// ============================================================================
const MasterPage = ({ 
  setActiveTab, 
  setIsSubViewOpen, 
  ...
  const handleKueSaved = useCallback(async (data) => {
  ...
  const handleBahanSaved = useCallback(async (data) => {
  ...
  const handleResepSaved = useCallback(async (namaKue, resepArray, yieldResult) => {
